...
/// before daybook entries existed — so an omitted audience is the behaviour those callers already have,
...
public interface IDigestQueryService
{
    ...
    /// all of which may describe the same day; for <see cref="DigestAudience.Daybook"/> it is one
