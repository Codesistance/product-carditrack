...
namespace CardiTrack.Infrastructure.Migrations
{
    ...
    [Migration("20260926134252_AddMemberChatTurnPendingOffer")]
    partial class AddMemberChatTurnPendingOffer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.BenignJudgement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.CardiMember", b =>
                {
                    ...
                    b.Property<DateTime?>("MedicalNotesReviewedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.CardiMemberCreationKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.DeviceConnection", b =>
                {
                    ...
                    b.Property<bool?>("IrnEnrolled")
                        .HasColumnType("boolean");

                    b.Property<bool?>("IrnOnboarded")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("IrnProfileUpdatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.DeviceConnectionInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CardiMemberId", "DeviceType")
                        .IsUnique()
                        .HasDatabaseName("IX_DeviceConnectionInvites_OneLivePerMemberDevice")
                        .HasFilter("\"Status\" IN ('Pending', 'Opened')");

                    b.ToTable("DeviceConnectionInvites", (string)null);
                });

            modelBuilder.Entity("CardiTrack.Domain.Entities.DeviceHistoryRepull", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateOnly?>("CompletedTo")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("DeviceConnectionId", "RequestedAt")
                        .IsDescending(false, true);

                    b.ToTable("DeviceHistoryRepulls", (string)null);
                });
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.ExportConsent", b =>
                {
                    ...
                    b.Property<string>("RememberFor")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<DateTime?>("RememberUntil")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid?>("ReusedFromConsentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.GenerationLease", b =>
                {
                    ...
                    b.HasIndex("CardiMemberId", "Work")
                        .IsUnique();

                    b.ToTable("GenerationLeases", (string)null);
                });
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.MemberAdviseObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CardiMemberId", "ObservedAtUtc");

                    b.ToTable("MemberAdviseObservations", (string)null);
                });

            modelBuilder.Entity("CardiTrack.Domain.Entities.MemberAiHold", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CardiMemberId", "Purpose")
                        .IsUnique();

                    b.ToTable("MemberAiHolds", (string)null);
                });
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.MemberChatSession", b =>
                {
                    ...
                    b.Property<DateTime?>("PendingActionExpiresAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("UserId", "CardiMemberId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.MemberChatTurn", b =>
                {
                    ...
                    b.Property<string>("PendingChange")
                        .HasColumnType("text");

                    b.Property<string>("PendingOffer")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.NotificationDelivery", b =>
                {
                    ...
                    b.Property<string>("NudgeRuleCode")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CardiTrack.Domain.Entities.RhythmEpisode", b =>
                {
                    b.Property<Guid>("CardiMemberId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MaxRrMs")
                        .HasColumnType("integer");

                    b.Property<int>("MeanRrMs")
                        .HasColumnType("integer");

                    b.Property<int>("MinRrMs")
                        .HasColumnType("integer");

                    b.Property<DateTime>("NotificationStartUtc")
                        .HasColumnType("timestamp with time zone");

                    b.PrimitiveCollection<int[]>("OffsetMillisFromStart")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.Property<int?>("RmssdMs")
                        .HasColumnType("integer");

                    b.PrimitiveCollection<int[]>("RrMilliseconds")
                        .IsRequired()
                        .HasColumnType("integer[]");
