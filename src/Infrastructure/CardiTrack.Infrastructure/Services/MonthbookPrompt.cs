...
internal static class MonthbookPrompt
{
    ...
    internal const string Instructions =
        ...
        Read one month of this person's readings. The month is over.
        ...
        - finding: an account of the month as a whole, saying what moved and what held steady across it, keeping
          every figure, and saying how much of the month each reading covered. Say where the month
          sat against any published band. An unremarkable month is allowed to be a short account,
          but it still says what was measured. 8-14 sentences.
