...
internal static class WeekbookPrompt
{
    ...
    internal const string Instructions =
        ...
        Write the family's account of one week of {{NAME}}'s readings. The week is over.
        ...
        - summary: 6-12 sentences to the family, an account of the week as a whole, naming the
          person as {{NAME}} — never a relationship stand-in. An unremarkable week is allowed to be
        ...
        - headline: a five-to-seven-word qualification of the week you just described — what kind
          ...
          title any week at all. Sentence case, no full stop, no name and no {{NAME}}, not a
          sentence.
