...
public class InsightsController : BaseApiController
{
    ...
    /// <summary>
    /// A general wellness suggestion for a CardiMember, grounded in their own readings and public-health
    /// wellness guidelines (activity, sleep, resting heart rate) — never a diagnosis, a prescription,
    /// or a treatment change. See <c>MedicalPromptBlocks.WellnessGuidelineReference</c>. Generated by
    /// the pipeline's batch pass and persisted per member; read-only here, no model call on this path.
