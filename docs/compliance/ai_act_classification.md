...
is a device; (ii) that device's MDR class requires a notified body (Class IIa or above — a
Class I self-declared device does not satisfy Art. 6(1)(b)); and (iii) the AI system is the
