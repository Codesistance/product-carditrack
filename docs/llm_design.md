...
- Plain-language overnight summary: sleep quality, HRV trend, any medium events from the prior 24 h (**built** — see `DigestGenerator`; the job runs quarter-hourly against the member's day in progress rather than once at 08:00)
