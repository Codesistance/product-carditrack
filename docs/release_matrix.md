...
| **The Daybook — weekly round-up** | R2 | R2 | — | Complete Care | ⬜ **Not started — but sold.** The pricing page lists a weekly Daybook under Complete Care as of 2026-08-18. Only the once-daily `DigestAudience.Daybook` exists (own row above, prod-gated). A weekly cadence needs its own audience value, its own job schedule and its own prompt — a week is not a longer day, and the daily prompt's register does not carry over unexamined |
| **The Daybook — monthly round-up** | R2 | R2 | — | Guardian Plus | ⬜ **Not started — but sold.** Same as the weekly row, listed under Guardian Plus. Note the retention interaction: minute-grain readings are dropped at 90 days and hourly rollups at 13 months, so a monthly entry composed months later can only draw on what survives the partition drops |
