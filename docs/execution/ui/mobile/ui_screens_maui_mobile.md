...
- **As built:** primary caregivers can tap the Phone card (or its edit affordance when empty) to open M1-14 scrolled to the Phone Number field (`focus=phone`) — same save path as the header pencil
