...
> **Build status (August 9, 2026):** 13 of 17 Figma M1 screens are built (M1-01 through M1-10, plus M1-13–M1-15); M1-11, M1-12, M1-16 and M1-17 show "Coming soon" dialogs. Four shipped screens have **no Figma M1 frame — needs design sync**: SignInPage, ForgotPasswordPage, VerifyEmailPage, Onboarding/AccountSetupPage (Stories 1.5–1.8).
