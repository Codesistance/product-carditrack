...
> **13 of 17 Figma M1 screens are built** in `CardiTrack.Mobile`: M1-01 through M1-10, plus M1-13, M1-14 and M1-15. **M1-11, M1-12, M1-16 and M1-17 are not built** — their entry points show "Coming soon" dialogs. **Four shipped screens have no Figma M1 frame — needs design sync:** SignInPage, ForgotPasswordPage, VerifyEmailPage, Onboarding/AccountSetupPage (specs in the canonical doc). Unbuilt screens below remain design intent, each marked with a status line.
