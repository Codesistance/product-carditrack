...
| Apple Watch | Series 4+ | Via Google Health — routes to the Google Health connect flow once the brand is mapped (decided 2026-09-05) |
| Samsung Galaxy Watch | All models | Via Google Health — same as Apple Watch |
...
**Card 1: Activity**
- Icon: shoe | Value: "4,250 steps" | Progress bar (today vs previous calendar day; max grows to today once today is ahead; two stacked colours when ahead)
