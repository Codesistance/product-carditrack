...
- **Datadog.Maui** (Android/iOS only): **logs, traces and RUM with Datadog crash reporting**, all behind the caregiver's opt-in (crashes/ANRs also in Play Console vitals), wired through the `MobileApm` registry
