...
public class DashboardServiceTests
{
    ...
    public async Task DataWithoutBaseline_IsLearning_WithNullChangePercent()
    {
        ...
        Assert.Equal("unknown", result.HealthStatus);
        // No usual day yet. This used to be a flat 10,000 — a 1965 pedometer brand name, which is
        // the invention HealthReferenceRanges refuses to make for steps. The dashboard bar does
        // not use this field; it fills against the previous calendar day from the series.
