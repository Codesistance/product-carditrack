...
/// separate anything. The solver is Math.NET Numerics' symmetric EVD; grouping and
/// hankelization stay ours.
/// </summary>
public class SsaDecompositionTests
{
    private const int N = 60;

    private static readonly SsaDecomposition Ssa = new();
    ...
    public void Reconstruction_RecoversTheInput_WithinRounding()
    {
        ...
        var result = Ssa.Decompose(series);
    ...
    {
        var result = Ssa.Decompose(Series(_ => 72.0));
    ...
    public void ASeriesShorterThanTwiceTheWindow_IsRefused()
    {
        Assert.Throws<ArgumentException>(() =>
            Ssa.Decompose(Enumerable.Repeat(70.0, 59).ToArray(), windowSize: 30));
    }
    ...
    public void ADegenerateWindow_IsRefused()
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            Ssa.Decompose(Series(_ => 70.0), windowSize: 1));
    }
}
